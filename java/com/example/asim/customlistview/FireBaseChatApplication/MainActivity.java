package com.example.asim.customlistview.FireBaseChatApplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebasechatapplication);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.firebase_main, menu);
        return true;
    }
    ...
    private void showAllOldMessages() {
        ...
        FirebaseListAdapter<ChatMessage> adapter = new MessageAdapter(this, ChatMessage.class, R.layout.activity_firebase_item_in_message,
